...
function wpdevart_ai_and_saas_agency_wda_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'wpdevart_ai_and_saas_agency_wda_customize_register' );